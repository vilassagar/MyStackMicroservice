...
{
    public class AuthContext : IdentityDbContext<ApplicationUser, Role, int>
    {
        private readonly DatabaseConfiguration _databaseConfig;
        private readonly List<object> _pendingChanges = new List<object>();
        public AuthContext(DbContextOptions<AuthContext> options, DatabaseConfiguration databaseConfig)
            : base(options)
        {
